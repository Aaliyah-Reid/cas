...
import 'package:cas/Components/colour.dart';
import 'package:cas/Components/onboarding_data.dart';
import 'sign_up.dart';
          ...
          setState(() {
            ...
            if(currentIndex == controller.items.length -1){
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => SignUpPage()), // Replace Onboarding with HomePage
              );
